...
const HeroBanner = () => {
  ...
  return (
    <div className="flex items-center text-gray-600 bg-[#ede1e1] px-8 py-16 md:py-24">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between md:gap-10">
        <div className="md:w-1/2 text-center md:text-left mb-4 md:mb-0 flex flex-col gap-5">
          ...
          <p className=" text-base w-full max-w-[48ch]">
            Discover a vast library of exercises, master proper form, and
            achieve your fitness goals with ease.
          </p>
          <div>
            <button
              className="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-full text-base transition-transform transform hover:scale-105 ease-in-out"
